...
CREATE TABLE CLOSEDCASH (
    ...
    CLDCASH DOUBLE PRECISION DEFAULT 0.0 NOT NULL,
...
--CREATE INDEX CLOSEDCASH_INX_1 ON CASHVALUE(DATESTART);
...
--CREATE INDEX CASHVALUE_INX_1 ON CASHVALUE(DATESTART);
--CREATE UNIQUE INDEX CASHVALUE_INX_SEQ ON CASHVALUE(HOST, HOSTSEQUENCE);
...
CREATE TABLE TICKETS (
    ID VARCHAR(256) NOT NULL,
    TICKETTYPE DOUBLE PRECISION DEFAULT 0.0 NOT NULL,
    TICKETID INTEGER NOT NULL,
    PERSON VARCHAR(256) NOT NULL,
    CUSTOMER VARCHAR(256),
    WALKINCUSTOMER VARCHAR(256),
...
CREATE TABLE TICKETLINES (
    ...
    ATTRIBUTES BLOB,
    WALKINCUSTOMERS VARCHAR(256),
    ADVANCE DOUBLE PRECISION,
    TOTALRECIEVABLE DOUBLE PRECISION,
